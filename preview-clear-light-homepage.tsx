...
export default function HomePage() {
  ...
  return (
    <div>
      {/* Hero Section — clearer and lighter */}
      <section className="relative h-[80vh] min-h-[550px] flex items-center justify-center overflow-hidden bg-stone-800">
        <img
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl">
          <h1
            className="text-5xl sm:text-6xl lg:text-7xl font-bold text-white mb-6 leading-[1.1] drop-shadow-xl uppercase"
            style={{ letterSpacing: '0.08em', textShadow: '1px 1px 4px rgba(0,0,0,0.6)' }}
          >
            Henry Koon Thinks
          </h1>
          <div className="w-20 h-0.5 bg-brand-400 mx-auto mb-6" />
          <p className="text-lg sm:text-xl text-stone-100 leading-relaxed font-light drop-shadow-md">
